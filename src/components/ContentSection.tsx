      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12">
          ...
          <div className="space-y-8">
            ...
            <div className="mb-8">
              <h2 className="font-sansation-regular font-bold text-[#004681] mb-3" style={{ fontSize: '30px' }}>
            ...
            <div className="mt-12">
              <h2 className="font-sansation-regular font-bold text-[#212529] mb-3" style={{ fontSize: '27px' }}>
                Current DCM Stats:
              </h2>
