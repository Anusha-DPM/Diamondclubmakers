...
const DCMCourseStructureSection = () => {
  return (
                                       <div className="bg-[#019fde] w-full" style={{ paddingTop: '40px', paddingBottom: '40px' }}>
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        {/* Section Heading */}
        <h2 
          className="font-sansation-regular text-white text-center mb-0 text-[27px] sm:text-[30px]"
          style={{ fontWeight: 400, lineHeight: '1.2', paddingBottom: '20px' }}
        >
          ...
          {/* Paragraph 1 */}
          <p className="font-sansation-regular text-white leading-relaxed text-[16px] sm:text-[17px]" style={{ paddingBottom: '15px' }}>
            All weekly lessons and all other topic segments are entirely over WhatsApp during each of the 24 weeks. They begin with a complete and detailed progression from A-Z on how I perform Invisalign within my high producing 700 plus cases a year only comprising 1/3 of my 5.1 million collections office. From the consult all the way to completion with each and every step between. I include internal and external marketing, case examples, Clincheck reviews and guidance, patient management, and ways to make Invisalign one of the more profitable procedures within your office while driving your overall growth to new heights. The last third of the course is focused on practice management, creating time and space for the huge increase in production and collections you are about to experience, amplifying your efforts by creating an efficient team around you, and so much more.
          </p>
          ...
          {/* Paragraph 3 */}
          <p className="font-sansation-regular text-white leading-relaxed text-[16px] sm:text-[17px]">
...
export default DCMCourseStructureSection;
