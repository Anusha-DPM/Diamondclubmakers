  ...
  return (
    <section className="bg-white py-8 sm:py-12 lg:py-16">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Main Title */}
        <h2 className="font-sansation-regular text-[#004681] mb-4 text-center text-[27px] sm:text-[30px]" style={{ fontWeight: 400, lineHeight: '1.2' }}>
          Three Average DCM Cases:
        </h2>
        
        {/* Introduction */}
        <p className="font-sansation-regular text-[#6b6b6b] leading-relaxed mb-4 text-left text-[16px] sm:text-[17px]">
        ...
        <div className="space-y-6 mb-6">
          ...
          {/* Average Case Time */}
          <div>
            <p className="font-sansation-regular text-[#6b6b6b] mb-2 text-[16px] sm:text-[17px]">
              Average Case Time:
            </p>
            <p className="font-sansation-regular text-[#6b6b6b] leading-tight mb-1 text-[16px] sm:text-[17px]">
              Doctor time 21minutes
            </p>
            <p className="font-sansation-regular text-[#6b6b6b] leading-tight text-[16px] sm:text-[17px]">
        ...
        {/* Program Benefits */}
        <div className="mb-8">
          <p className="font-sansation-regular text-[#6b6b6b] leading-relaxed mb-2 text-[16px] sm:text-[17px]">
        ...
        <div className="mb-6">
          <ul className="space-y-1">
            <li className="flex items-start">
              ...
              <span className="font-sansation-regular text-[#6b6b6b] leading-relaxed text-[16px] sm:text-[17px]">
        ...
        <div className="space-y-6">
          ...
          {/* Case 1: Anthony L. */}
          <div>
            <h3 className="font-sansation-regular text-[#004681] mb-3 text-[27px]" style={{ fontWeight: 400, lineHeight: '1.2' }}>
              Anthony L.
            </h3>
            <p className="font-sansation-regular text-[#6b6b6b] leading-relaxed mb-4 text-[16px] sm:text-[17px]">
          ...
          {/* Case 3: Gordon G. */}
          <div>
            <h3 className="font-sansation-regular text-[#004681] mb-4 text-[27px]" style={{ fontWeight: 400, lineHeight: '1.2' }}>
              Gordon G.
            </h3>
            <p className="font-sansation-regular text-[#6b6b6b] leading-relaxed mb-6 text-[16px] sm:text-[17px]">
