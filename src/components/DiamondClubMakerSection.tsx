  ...
  return (
    <section className="bg-white pt-12 sm:pt-16 lg:pt-20">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        {/* Main Title */}
        <h1 
          className="font-sansation-regular text-[#004681] text-center mb-3 sm:mb-4 lg:mb-6 text-[27px] sm:text-[30px]"
        ...
        <div className="mb-6 sm:mb-8 lg:mb-10">
          <h2 
            className="font-sansation-regular text-[#004681] mb-3 sm:mb-4 lg:mb-6 text-[27px]"
            style={{ fontWeight: 400, lineHeight: '1.2' }}
          >
        ...
        <div className="mb-12 sm:mb-16 lg:mb-20">
          <h2 
            className="font-sansation-regular text-[#004681] mb-6 sm:mb-8 lg:mb-10 text-[27px]"
            style={{ fontWeight: 400, lineHeight: '1.2' }}
          >
            Let&apos;s do DCM Math
          </h2>
       ...
       <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 mt-12">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
           ...
           <div className="col-span-1 sm:col-span-1 lg:col-span-1">
             <div className="relative">
               ...
               <div className="mt-3">
                 <p className="font-sansation-regular text-[#004681] text-[16px] sm:text-[17px]">
        ...
        <div className="bg-white pt-12 sm:pt-16 lg:pt-20" style={{ paddingBottom: '50px' }}>
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            {/* Heading */}
            <h2 
              className="font-sansation-regular text-[#004681] mb-4 text-[27px] sm:text-[30px]"
              style={{ fontWeight: 400, lineHeight: '1.2', marginBottom: '20px' }}
            >
            ...
            {/* Descriptive Text */}
            <p className="font-sansation-regular text-[#6b6b6b] leading-relaxed max-w-4xl mx-auto text-[16px] sm:text-[17px] pt-5 px-4 sm:px-8 md:px-16 lg:px-28">
           ...
           <div className="bg-white pt-0 pb-0">
             <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
               <div className="space-y-6">
                 ...
                 <p className="font-sansation-regular text-[#6b6b6b] leading-relaxed italic text-[16px] sm:text-[17px]">
