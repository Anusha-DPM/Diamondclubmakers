    ...
    <div className="bg-white pt-12 sm:pt-16 lg:pt-20 w-full" style={{ paddingBottom: '50px' }}>
      <div className="w-full px-4 sm:px-6 lg:px-8">
        ...
        <div className="relative w-full">
          ...
          <button 
            className="absolute left-2 sm:left-4 lg:left-0 top-1/2 transform -translate-y-1/2 z-20 bg-white border border-gray-300 rounded-full p-1.5 sm:p-2 shadow-lg hover:bg-gray-50 transition-colors duration-200 active:bg-gray-100"
            onClick={() => {
          ...
          <button 
            className="absolute right-2 sm:right-4 lg:right-0 top-1/2 transform -translate-y-1/2 z-20 bg-white border border-gray-300 rounded-full p-1.5 sm:p-2 shadow-lg hover:bg-gray-50 transition-colors duration-200 active:bg-gray-100"
            onClick={() => {
              const carousel = document.getElementById('dcm-carousel');
              if (carousel) carousel.scrollLeft += 300;
            }}
          ...
          >
            {/* DCM First */}
            <div className="flex flex-col items-center min-w-[240px] sm:min-w-[220px] lg:min-w-[200px] flex-shrink-0">
              <div className="relative">
                <Image 
                  ...
                  width={200}
                  height={200}
                  className="w-auto h-[180px] sm:h-[200px] object-contain"
                />
              </div>
            </div>
